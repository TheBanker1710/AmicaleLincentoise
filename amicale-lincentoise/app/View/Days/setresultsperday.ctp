  ...
  <select id="selectDay">
      ...
      ?>
        <option value="<?php echo $value['Day']['id']; ?>"
          ...
          ?>
          >Journée <?php echo $value['Day']['number']; ?> - <?php echo date_format(new \DateTime($value['Day']['date']),"d/m/Y"); ?></option>
      <?php
      $dayItem += 1;
      }
      ?>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th width="70">Score équipe à domicile</th>
            <th width="70">Score équipe à l'extérieur</th>
          </tr>
        </thead>
        <tbody>
        <?php
